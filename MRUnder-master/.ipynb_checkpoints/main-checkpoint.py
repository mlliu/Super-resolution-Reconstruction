...
fullySampledPath = r'../oasis_data/anat1'#r'/run/media/soumick/Enterprise/Datasets/IXI/ISO_Resampled2T2/T1' #Root path containing fully sampled images (NIFTIs: .img, .nii, .nii.gz or DICOMs: .ima, .dcm)
...
underSampledOutPath =r'../oasis_data/anat1_7fold'# r'/run/media/soumick/Enterprise/Datasets/IXI/ISO_Resampled2T2/BiLinear256/Under/T1' #Root path to store the undersampled output
outFolder = r'CentreSquare15p25Mask' #Inside the underSampledOutPath, this folder will be created. Inside which the undersampled results will be stored
...
percentOfKSpace = 0.15 #[between 0 and 1] Percent of k-Space to be sampled. To be used for Cartesian samplings except undersamplingType = 2, 4
